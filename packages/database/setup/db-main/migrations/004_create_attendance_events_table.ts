...
export const createAttendanceEventsTable: Migration = {
  ...
  up: async (db: Kysely<any>) => {
    ...
    await db.schema
      ...
      .addColumn("event_type", sql`attendance_event_type`, (col) =>
        col.notNull()
      )
  ...
  down: async (db: Kysely<any>) => {
    ...
    await sql`DROP TYPE IF EXISTS attendance_event_type`.execute(db);
  },
};
